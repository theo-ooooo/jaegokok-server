...
public class EmailAdapter implements EmailPort {
    ...
    public void sendPasswordReset(String toEmail, String resetUrl) {
        try {
            ...
            helper.setTo(toEmail);
            helper.setFrom("noreply@jaegokok.com", "재고콕");
            helper.setSubject("[재고콕] 비밀번호 재설정 안내");
                  ...
                  <table width="540" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(25,31,40,.08);">
                    ...
                    <tr>
                      <td style="padding:40px 40px 32px;">
                        <h1 style="margin:0 0 12px;font-size:20px;font-weight:800;color:#191F28;letter-spacing:-.03em;">비밀번호 재설정 요청</h1>
                        <p style="margin:0 0 24px;font-size:15px;color:#4E5968;line-height:1.6;">
                          비밀번호 재설정 요청이 접수되었습니다.<br>
                          아래 버튼을 클릭해 30분 이내에 비밀번호를 변경하세요.
                        </p>
                        <!-- CTA Button -->
